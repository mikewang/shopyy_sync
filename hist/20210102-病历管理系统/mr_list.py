...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    mr_list_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.back.configure(command=mr_list_support.comeback)
        ...
        self.Treeview.heading("Col3", text="诊断时间")
        self.Treeview.heading("Col3", anchor="center")
        self.Treeview.column("Col3", width="100")
        self.Treeview.column("Col3", minwidth="20")
        self.Treeview.column("Col3", stretch="1")
        self.Treeview.column("Col3", anchor="center")
        self.Treeview.heading("Col4", text="诊断意见")
        self.Treeview.heading("Col4", anchor="center")
        self.Treeview.column("Col4", width="260")
        self.Treeview.column("Col4", minwidth="100")
        self.Treeview.column("Col4", stretch="1")
        self.Treeview.column("Col4", anchor="center")
        self.Treeview['show'] = 'headings'
        try:
            conn = pymysql.connect(host=db_hostname, user='myuser', passwd='myuser', db='mydb', port=3306)
            cur = conn.cursor()
            global  patient_id
            if patient_id == 0:
                cur.execute('select a.patient_name,a.doctor_name,a.mr_date,a.mr_result from v_mr as a')
            else:
                cur.execute('select a.patient_name,a.doctor_name,a.mr_date,a.mr_result from v_mr as a  where a.patient_id=%s', int(patient_id))

            rows = cur.fetchall()
            i = 0
            for r1 in rows:
                self.Treeview.insert('', i, values=(r1[0], r1[1], r1[2], r1[3]))
                i += 1
